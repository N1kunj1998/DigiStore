      ...
      <div className="container relative z-10">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 animate-fade-in" style={{ animationDelay: "0.1s" }}>
            Access premium digital resources including executive book summaries, strategic workbooks, and professional development courses designed for ambitious professionals and business leaders.
          </p>
